...
def get_env_type(env_name):
    ...
    if (
        "navigate" in env_name
        or "stitch" in env_name
        or "explore" in env_name
        or "cube" in env_name
...
def _get_negative_reward(env_name, reward_scale, reward_bias):
    ...
    if "antmaze" in env_name and ("diverse" in env_name or "play" in env_name):
    ...
    elif "maze" in env_name or "cube-single" in env_name:
        reward_neg = (
        ...
        reward_neg = ENV_REWARD_INFO["scene"]["reward_neg"] * reward_scale + reward_bias
    else:
        raise NotImplementedError(
            """
